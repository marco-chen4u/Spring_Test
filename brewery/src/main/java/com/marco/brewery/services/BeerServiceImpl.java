...
import com.marco.brewery.repositories.BeerRepository;
import com.marco.brewery.web.mapper.BeerMapper;
...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerDto findBeerById(UUID beerId) {
        Optional<com.marco.brewery.domain.Beer> beerOptional = beerRepository.findById(beerId);
